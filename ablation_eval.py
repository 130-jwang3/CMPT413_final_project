...
def eval_normal_reference(plot_enable=False):
    eval_log_root = f"C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\log/Ablation/few-shot"
    processed_data_root = "C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\output"
...
def eval_window_size(plot_enable=False):
    ...
    eval_log_root = f"C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\log/Ablation/window_size"
    processed_data_root = "C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\output/Ablation"
    default_confidence = 9
    default_PAT = 0
...
def eval_tick(plot_enable=False):
    ...
    dataset_list = ['NormA']
    eval_log_root = f"C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\log/Ablation/ticks"
    processed_data_root = "C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\output/Ablation"
    default_confidence = 9
    default_PAT = 0
    for dataset_name in dataset_list:
...
def LMM_ablation():
    LLM_list = ['GPT-4o','GPT-4o-mini','deepseek','Claude', 'gemini-1.5-pro', 'gemini-1.5-flash', 'GLM-4v-plus', 'qwen-vl-max', 'qwen-vl-plus']
    NR_list = [0, 1]
    dataset_name = 'UCR'
