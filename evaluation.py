...
config = {
    "UCR": {
        ...
        # 'log_root': 'C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\log/',
        'log_root': 'C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\log\\',
        # 'log_root': 'C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\log/AuxLine-3', 
        # 'log_root': 'C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\log/TAMA-3',
        'data_id_list': ['135','136','137','138'],
    },
    "NASA-MSL": {
        # 'log_root': './log/log_nas/anomaly_detection/NASA-MSL-All-1',
        # 'log_root': 'C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\log/Rotation',
        # 'log_root': 'C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\log/TextModality',
        'log_root': 'C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\log/text_modality',
    ...
    "NASA-SMAP": {
        # 'log_root': './log/', 
        # 'log_root': 'C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\log/AuxLine-1',
        'log_root': 'C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\log/TextModality',
        # 'log_root': 'C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\log/TAMA-3',
...
def evaluate_each_data_id():
    dataset_name = 'UCR'
    subtask_name = ''
    processed_data_root = os.path.join('C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\output', subtask_name)
    dataset_info = make_dataset.dataset_config[dataset_name]
    window_size = dataset_info['window']
    # stride = dataset_info['stride']
    stride = 150
...
def evaluate_metrics():
    ...
    # stride = 300
    log_path =  config[dataset_name]['log_root']
    # log_path = 'C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\log/synthetic_datasets-all-2'
    print(f'SubTask: {subtask_name}, {dataset_name}, log: {log_path}, stride: {stride}')
    print(f'Processed data root: {processed_data_root}')
    evaluator = Evaluator(dataset_name, stride, processed_data_root, log_root=log_path)
...
def fix_log():
    ...
    import numpy as np
    dataset_name = 'synthetic_datasets'
    original_log = yaml.safe_load(open('C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\log/log_nas/anomaly_detection/synthetic_datasets-all/synthetic_datasets_log_origin.yaml'))
    processed_data_path = 'C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\output'
    ...
    with open('C:\\Users\\johnw\\Documents\\TSAD\\TAMA\\log/log_nas/anomaly_detection/synthetic_datasets-all/synthetic_datasets_log.yaml', 'w') as f:
