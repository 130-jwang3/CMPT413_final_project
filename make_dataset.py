...
def args_parse():
    parser = argparse.ArgumentParser(description='Command line interface for make_dataset.py')
    ...
    parser.add_argument('--use_eh_gam_egan', type=str, default='True', help='Use EH-GAM-EGAN for preprocessing', required=False)
    args = parser.parse_args()
    
    args.data_id_list = args.data_id_list.strip('][').replace(' ', '').split(',')
    args.aux_enable = args.aux_enable.lower() == 'true'
    args.use_eh_gam_egan = args.use_eh_gam_egan.lower() == 'true'
...
if __name__ == '__main__':
    ...
    output_dir = os.path.join(task_config['processed_data_path'], subtask)
